...
public final class XmlUtils {
    ...
    public static void main(String[] arg){
    	...
    	xmlAsString=xmlAsString+"<messages>";
    	xmlAsString=xmlAsString+"<message><result>0</result><result_describe>发送成功</result_describe><count>200</count></message>";
    	xmlAsString=xmlAsString+"<message><result>0</result><result_describe>发送成功</result_describe><count>399</count></message>";
    	xmlAsString=xmlAsString+"</messages>";
    	String aString="<?xml version=\"1.0\" encoding=\"utf-8\"?><response><return_code>N</return_code><return_message>@ddfdsfsdfsf表或视图不存在</return_message></response>";
    	String element="result";
    	String result = XmlUtils.getTextForElement(aString, "return_message");
